...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-md-6">
            <h2><i class="fas fa-arrow-down text-success"></i> Entradas Múltiples</h2>
            <p class="text-muted">Registro de lotes de entrada al almacén</p>
        </div>
        <div class="col-md-6 text-end">
            <a href="{{ route('stock-entry-batches.create') }}" class="btn btn-success">
                <i class="fas fa-plus"></i> Nueva Entrada Múltiple
            </a>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('stock-entry-batches.index') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        @forelse($batches as $batch)
                            <tr>
                                <td>
                                    <strong>{{ $batch->entry_date->format('d/m/Y') }}</strong><br>
                                </td>
                                <td>
                                    <span class="badge bg-secondary">{{ $batch->supplier->name }}</span>
                                </td>
                                <td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        @if(Auth::user()->isAdmin())
                                            <form action="{{ route('stock-entry-batches.destroy', $batch) }}" 
                                                  method="POST" 
                                                  class="d-inline"
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4">
                                    ...
                                    <p class="text-muted">No se encontraron entradas múltiples</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
